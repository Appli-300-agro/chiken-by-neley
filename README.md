# chiken by neley - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **chiken by neley**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@chikenbyneley.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@chikenbyneley.cm` | `user123` | |
...
*   **Contact :** contact@chikenbyneley.cm